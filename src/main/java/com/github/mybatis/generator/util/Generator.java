...
import com.github.mybatis.generator.entity.ResultJson;
...
public class Generator {
	...
	public static ResultJson createEntity(String url,BasisInfo bi) {
		String fileUrl= getGeneratorFileUrl(url, bi.getEntityUrl()+".dto", bi.getEntityName(), ENTITY);
	...
	//⑨创建Params
	public static ResultJson createParams(String url,BasisInfo bi) {
		String fileUrl= getGeneratorFileUrl(url, bi.getEntityUrl()+".params", bi.getEntityName(), PARAMS);
		return FreemarkerUtil.createFile(bi, "params.ftl", fileUrl);
	}

	//⑩创建Example
	public static ResultJson createExample(String url,BasisInfo bi) {
		String fileUrl= getGeneratorFileUrl(url, bi.getEntityUrl()+".dto", bi.getEntityName(), EXAMPLE);
		return FreemarkerUtil.createFile(bi, "example.ftl", fileUrl);
	}
	...
	public static String getGeneratorFileUrl(String url,String packageUrl,String entityName, String type){
		if (type.equals("entity")) {
			...
			return url+pageToUrl(packageUrl)+entityName+"Params.java";
		}else if(type.equals("example")){
			return url+pageToUrl(packageUrl)+entityName+"Example.java";
		}
		return null;
	}
